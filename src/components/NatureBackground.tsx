...
// Memoize the WebGL shader so it doesn't re-render/re-compile on every state update or scrape poll
const MemoizedShader = memo(function MemoizedShader({ isDark }: { isDark: boolean }) {
